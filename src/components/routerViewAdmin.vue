<template>
  <div class="pages">
    <div class="page-header">
      ...
      <div class="right">
<!--        <span class="right-item">您好，{{userInfo.name}}</span>-->
<!--        <a class="right-item" @click="updatePwd">修改密码</a>-->
<!--        <a class="right-item" @click="logout">退出登录</a>-->
    ...
    <div class="page-container">
      <el-dialog :destroy-on-close="true" :close-on-click-modal="false" title="修改密码" :visible.sync="flag" width="850px">
        <el-form>
  ...
  export default {
    ...
    methods: {
      ...
      save () {
        ...
        // this.form.reNewPassword = md5(md5(this.form.reNewPassword))
        // let params = Object.assign({}, this.form, { user: this.userInfo.user })
